...
/**
 * Representa un elemento del menú principal de la aplicación, incluyendo su icono,
 * nombre visible y tipo de comportamiento dentro de la interfaz.
 * 
 * Esta clase se utiliza para generar dinámicamente los ítems del menú lateral o superior
 * en función de su categoría (título, opción o espacio vacío).
 * 
 * <p>Los iconos se cargan desde la ruta <b>/_08_SourcesGUI/</b> y deben tener formato PNG.</p>
 * 
 * Ejemplo:
 * <pre>
...
public class Model_Menu {
     ...
     * Busca la imagen dentro del paquete <b>/_08_SourcesGUI/</b> y la carga como PNG.
     * 
